  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden pt-16">
      ...
      <div className="absolute inset-0">
        <img
          src={heroImage}
          alt="Agricultural farmland with logistics warehouse"
      ...
      <div className="relative container mx-auto max-w-6xl px-4 py-24">
        <div className="max-w-2xl">
          ...
          <motion.h1
            ...
            className="font-serif text-5xl md:text-6xl lg:text-7xl text-primary-foreground leading-[1.1] mb-6"
          >
            Farm to Market,{" "}
          ...
          <motion.p
            ...
            className="text-primary-foreground/80 text-lg md:text-xl mb-10 leading-relaxed max-w-xl"
          >
